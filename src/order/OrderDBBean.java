...
public class OrderDBBean {
	...
	public int insertOrder(OrderDataBean orderDto) {
		...
		try { 
			...
			pstmt.setString(2, orderDto.getDelivery_tel());
			pstmt.setString(3, orderDto.getDelivery_zipcode());
			pstmt.setString(4, orderDto.getDelivery_address());
			pstmt.setString(5, orderDto.getDelivery_msg());
			pstmt.setInt(6, orderDto.getTrack_num());
			pstmt.setString(7, orderDto.getTrack_com());
			pstmt.setString(8, orderDto.getPay_method());
			pstmt.setString(9, orderDto.getOrder_state());
			pstmt.setString(10, orderDto.getId());
			pstmt.setInt(11, orderDto.getGoods_number());
			pstmt.setInt(12, orderDto.getGoods_count());
			result = pstmt.executeUpdate();
			if(result != 0) {
				pstmt.close();
				sql = "update dh_goods set sell_count = sell_count + 1 where goods_number = ?";
				pstmt = con.prepareStatement(sql);
				pstmt.setInt(1, orderDto.getGoods_number());
				pstmt.executeUpdate();
			}
	...
	public ArrayList<OrderDataBean> getArticles(int start, int end ){
		...
		try {
			con = getConnection();
			String sql = "select order_date, order_number, id, name, goods_name, order_state, r "
					+ "from(select order_date, order_number, id, name, goods_name, order_state, rownum r "
					+ "from(select o.order_date, o.order_number, d.id, d.name, g.goods_name, o.order_state "
		 ...
		 ArrayList<OrderDataBean> articles = null;
			...
			try {
				...
				String sql ="select o.order_date, o.order_number, d.id, d.name, g.goods_name, "
						...
						+"o.track_com, o.track_num, o.pay_method "
						+"from dh_member d, dh_goods g, dh_order o " 
