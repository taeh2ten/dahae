			...
			<div id="main">
				...
				<table class = "form-inline" style = "margin-right: auto; margin-left: auto; width: 800px">
				 <c:forEach var="orderDto" items="${result}">
					<tr>
						<th colspan = "5" class = "page-header"> 주문 번호  : ${orderDto.order_number}</th>
					</tr>
					<tr>
						<th colspan = "5" class = "page-header"> 주문 상황 : <label style="color:red;"> ${orderDto.order_state} </label> </th>
					</tr>
					<tr>
					...
					<tr>
						<td align="center" style="font-size:20px;">${orderDto.goods_name}</td>
						<td align="center" style="font-size:20px;"><img src="${upload}${orderDto.goods_images}" width = "180px" height = "auto"></td>
						<td align="center" style="font-size:20px;">${orderDto.goods_info}</td>
						<td align="center" style="font-size:20px;">${orderDto.goods_count}</td>
						<td align="center" style="font-size:20px;"><fmt:formatNumber value="${orderDto.price}"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<th style = "text-align: center;"> 배송시 요청사항 </th>
