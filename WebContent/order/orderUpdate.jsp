...
<html>
	...
	<div id="wrapper">
			...
			<div id="main">
				...
				<form method = "post" action = "orderUpPro.do" name = "orderUpdate" onsubmit = "return ordercheck()"> 
				<table class = "form-inline" style = "margin-right: auto; margin-left: auto; width: 800px">
				 <c:forEach var="orderDto" items="${orderDto}">
					...
					<tr>
						<th style = "font-size:13px;text-align: center;"> 상품명 </th>
						<th style = "font-size:13px;text-align: center;"> 상품이미지 </th>
						<th style = "font-size:13px;text-align: center;"> 상품정보 </th>
						<th style = "font-size:13px;text-align: center;"> 수량 </th>
						<th style = "font-size:13px;text-align: center;"> 가격 </th>
					</tr>
					<tr>
						<td style = "font-size:13px; text-align: center;">${orderDto.goods_name}</td>
						<td style = "font-size:13px; text-align: center;"><img src="${upload}${orderDto.goods_images}" width = "180px" height = "auto"></td>
						<td style = "font-size:13px; text-align: center;">${orderDto.goods_info}</td>
						<td style = "font-size:13px; text-align: center;">${orderDto.goods_count}</td>
						<td style = "font-size:13px; text-align: center;"><fmt:formatNumber value="${orderDto.price}"/></td>
					</tr>
					<tr>
						<th colspan = "5" class = "page-header"> <br> 받는분 </th>
					</tr>
					<tr>
					...
					<tr>
						<th colspan = "5" class = "page-header"> <br> 배송지 </th>
					...
					<tr>
						<th colspan = "5" class = "page-header"> <br> 배송 조회 </th>
					</tr>
					<tr>
						<th style="text-align:center;">택배회사</th>
						  <td>
						...
						<th style="text-align:center;"> 운송장 번호 </th>
						<td>
							<c:if test="${orderDto.track_num != 0}">
								<input class = "form-control" type="text" name = "track_num" value="${orderDto.track_num}"> 
							</c:if>
							<c:if test="${orderDto.track_num == 0}">
					...
					<tr>
						<th colspan = "5" class = "page-header"> <br> 총 결제 금액 </th>		
					</tr>
					<tr>
					...
					<tr>
						<th colspan = "5" class = "page-header"> <br> 결제수단 </th>
					</tr>
					<tr>
