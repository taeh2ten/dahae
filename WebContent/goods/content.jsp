				...
				<table class="table table-bordered"
					...
					<tr>
						<th colspan="2" style="text-align:center;">
							<input class="btn btn-info" type="button" value="${btn_modify}"
								onclick="location='goodsModifyForm.do?num=${goodsDto.goods_number}&pageNum=${pageNum}'">
							<input class="btn btn-info" type="button" value="${btn_delete}"
								onclick="location='goodsDeleteForm.do?num=${goodsDto.goods_number}&pageNum=${pageNum}'">
							<input class="btn btn-default" type="button" value="${btn_prelist}"
