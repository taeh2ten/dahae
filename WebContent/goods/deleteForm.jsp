				...
				<body>
					<form method="post" action="goodsDeletePro.do">						
						...
						<table style = "margin-left: auto; margin-right: auto;">
							<tr>
								<td align="center" style="height:100px; width:200px;">
									${msg_delete_check}
								</td>
							</tr>
							<tr>
								<th colspan="2" style="text-align:center;">
									<input class="btn btn-info" type="submit" value="${btn_del}">
									<input class="btn btn-default" type="button" value="${btn_del_cancel}"
