...
<html>
	...
	<body onload="g_writefocus()">
		<div id="wrapper">
			...
			<div id="main">
				<div align="center">
					<b class="page-header" style="font-size: 30px;">${page_write} <br> </b>
				</div>
				<div class="container">
					<form method="post" action="goodsWritePro.do" enctype="multipart/form-data" 
						...
						<table class="table table-bordered" style = "margin-right:auto; margin-left:auto; width: 1000px; font-size: 15px;">
							<tr>
							...
							<tr>
								<th colspan="2" style="text-align:center;">
									<input class="btn btn-info" type="submit" value="${btn_write}">
									<input class="btn btn-default" type="button" value="${btn_list}"
