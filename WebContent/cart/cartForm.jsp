	...
	<body>
		<div id="wrapper">
			...
			<div id="main">
				...
				<form name="cartForm">	
					<table class="table table-border table-striped table-hover" style = "width: 80%; margin : 0 auto;">
						<thead>
						<tr class="active">
							<th style="width : 20%; text-align:left">
								<input class="btn btn-danger btn-sm" type="button" value="${btn_delete_all}" onclick="location='cartDelete.do?goods_number=0&pageNum=${currentPage}'">
							</th>
